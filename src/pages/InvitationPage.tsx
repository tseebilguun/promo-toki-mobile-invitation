...
export default function InvitationPage() {
    ...
    const isSendEnabled = useMemo(() => phone.trim().length > 0 && !sendingInvite, [phone, sendingInvite])
    ...
    const onSend = () => {
        if (!jwt || !phone || sendingInvite) return
                        ...
                        <Drawer.Body px="16px" pt="10px" pb="calc(18px + env(safe-area-inset-bottom))">
                            <Stack gap="12px">
                                ...
                                <Box pt="20px">
                                    ...
                                    >
                                        {sendingInvite ? "Илгээж байна..." : "Урилга илгээх"}
                                    </Button>
                                </Box>
                            </Stack>
                        </Drawer.Body>
